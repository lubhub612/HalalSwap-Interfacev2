...
export const GlobalConst = {
  ...
  addresses: {
    ROUTER_ADDRESS: {
      [ChainId.MATIC]: '0x9aC5aaac56e1D1D61b83700a49cb8224F3AE0ad9',
    ...
    FACTORY_ADDRESS: '0x2329cD2Aba5d03cD3a337DA845AeC0b50bf728d2',
...
export const GlobalValue = {
  ...
  tokens: {
    ...
    COMMON: {
      ...
      HLAL: new Token(
        ChainId.MATIC,
        '0x59bFB89F870F9B5e409feA66e893bb533579C78F',
        18,
        'HLAL',
        'HALAL TOKEN',
      ),
  ...
  bases: {
    ...
    SUGGESTED_BASES: {
      ...
      [ChainId.MATIC]: [
        ...
        GlobalValue.tokens.COMMON.MI,
        GlobalValue.tokens.COMMON.HLAL,
      ],
    },
